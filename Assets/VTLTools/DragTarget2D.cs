...
{
	/// <summary>
	/// Drag a rb2d by selecting one of its colliders by pressing the mouse down.
	/// When the col is selected, add a TargetJoint2D.
	...
	public class DragTarget2D : MonoBehaviour
	{
		...
		void Update()
		{
			...
			if (Input.GetMouseButtonDown(0))
			{
				...
				// Add a target joint to the rb2d GameObject.
